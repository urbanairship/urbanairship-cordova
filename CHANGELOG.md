...
Major release that incorporates accessibility improvements from the iOS and Android SDKs, and fixes a potential crash on Android.
...
- Fixes a potential image-related crash in Scenes on Android.
- Improves accessibility with better VoiceOver focus control on iOS and heading fixes on Android.
