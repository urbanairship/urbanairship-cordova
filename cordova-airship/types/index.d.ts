...
export interface AirshipPush {
    ...
    getNotificationStatus(
        success: (enabled: PushNotificationStatus) => void,
        error?: (err: string) => void
    ): void
    ...
    onNotificationStatusChanged(
        callback: (event: PushNotificationStatusChangedEvent) => void
    ): Cancellable
     ...
     */
    getPushToken(
        success: (token: string | null | undefined) => void,
        error?: (err: string) => void
    ): void
    ...
    onNotificationResponse(
        callback: (event: NotificationResponseEvent) => void
    ): Cancellable
     ...
     */
    onPushTokenReceived(
        callback: (event: PushTokenReceivedEvent) => void
    ): Cancellable
}
...
export interface AirshipPushIOS {
     ...
     */
    getQuietTime(
        success: (quietTime?: iOS.QuietTime) => void,
        error?: (err: string) => void
    ): void
    ...
    onAuthorizedSettingsChanged(
        callback: (event: iOS.AuthorizedNotificationSettingsChangedEvent) => void
    ): Cancellable
}
...
export interface AirshipPreferenceCenter {
    ...
    */
     ...
     */
    onDisplay(
        callback: (event: DisplayPreferenceCenterEvent) => void
    ): Cancellable
}
/**
...
export interface AirshipMessageCenter {
     ...
     */
    onDisplay(
        callback: (event: DisplayMessageCenterEvent) => void
    ): Cancellable
     ...
     */
    onUpdated(
        callback: (event: MessageCenterUpdatedEvent) => void
    ): Cancellable
}
...
export interface AirshipInApp {
     ...
     */
    getDisplayInterval(
        success: (milliseconds: number) => void,
        error?: (err: string) => void
    ): void
}
...
export interface AirshipContact {
     ...
     */
    getNamedUserId(
        success: (namedUserId: string | null | undefined) => void,
        error?: (err: string) => void
    ): void
    ...
    getSubscriptionLists(
        success: (subscriptionLists: Record<string, SubscriptionScope[]>) => void,
        error?: (err: string) => void
    ): void
 ...
 * Airship channel.
 */
export interface AirshipChannel {
     ...
     */
    onChannelCreated(
        callback: (event: ChannelCreatedEvent) => void
    ): Cancellable
}
/**
 * Airship analytics.
...
export interface Airship {
     ...
     * @param success Success callback with the result. `true` if airship is ready.
     * @param error Error callback.
     */
    takeOff(
        config: AirshipConfig,
        success?: (isReady: boolean) => void,
        error?: (err: string) => void
    ): void

    /**
     * Checks if Airship is ready.
     * @param success Success callback with the result.
     * @param error Error callback.
     */
    isFlying(
