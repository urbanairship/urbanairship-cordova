...
cd `dirname "${0}"`/../
ROOT_PATH="$(pwd)"
CORDOVA_AIRSHIP_MODULE="$ROOT_PATH/cordova-airship"
CORDOVA_AIRSHIP_HMS_MODULE="$ROOT_PATH/cordova-airship-hms"
cd -
...
cp "$ROOT_PATH/Example/myMessageCenterStyleConfig.plist" myMessageCenterStyleConfig.plist
